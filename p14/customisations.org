...
** start charging and stop charging behaviour

#+BEGIN_EXAMPLE
gargle@p14:~/pandora/p14$ cat /sys/class/power_supply/BAT0/charge_start_threshold
60
gargle@p14:~/pandora/p14$ cat /sys/class/power_supply/BAT0/charge_stop_threshold
80
#+END_EXAMPLE
