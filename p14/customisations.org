...
** global settings for the monitors

#+BEGIN_example
gargle@p14:~$ cat /etc/sway/config.d/monitors.conf
output eDP-1 pos 0 0 res 1920x1200
output DP-7 pos 1920 0 res 1920x1080
#+END_example
...
#+BEGIN_example
gargle@p14:~$ ls /usr/share/backgrounds/*jpg
'/usr/share/backgrounds/Don-Quixote 1920x1080.jpg'  '/usr/share/backgrounds/Don-Quixote 1920x1200.jpg'
#+END_example

We only change the background, the default-user-image becomes the debian logo,and we make sure our
greeter starts on the laptop's own screen instead of on an external monitor.
