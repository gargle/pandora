...
** dns
We use the cloudfare dns servers instead of our own.

#+BEGIN_example
root@p14:/etc# diff /etc/resolv.conf /etc/resolv.conf.old
1,5c1,3
...
#+BEGIN_example
root@p14:/etc# diff /etc/dhcp/dhclient.conf /etc/dhcp/dhclient.conf.old
24,26d23
<
