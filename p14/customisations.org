...
# Set the domain for local queries
domain-needed
bogus-priv
local=/lan/

# Specify your local DNS records
address=/lan/192.168.1.1  # Change this to your desired local address
...
-rw-r--r-- 1 root root 21 Oct  4 20:47 /etc/resolv.conf
#+END_example

The original /etc/resolv.conf looked like this.
