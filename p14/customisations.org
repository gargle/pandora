...
set and get XDG_PICTURES_DIR for all grim and grimshot screenshots

#+BEGIN_example
gargle@p14:~$ xdg-user-dirs-update --set PICTURES /tmp
#+END_example

#+BEGIN_example
gargle@p14:~$ xdg-user-dir PICTURES
/tmp
#+END_example

#+BEGIN_example
gargle@p14:~$ cat ~/.config/user-dirs.dirs
