...
default cloudfare dns servers aren't used when connecting to a new access point without a passphrase.
...
(
    ...
    ("rxvt gold", EXEC, "rxvt -bg gold -fg black"),
    ("rxvt yellow", EXEC, "rxvt -bg yellow -fg black"),
    (rxvt, EXEC, "rxvt -bg white -fg black")
)
#+END_example
...
Emacs.font: -PfEd-DejaVu Sans Mono-regular-normal-normal-*-15-*-*-*-m-0-iso10646-1
