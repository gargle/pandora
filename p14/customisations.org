...
** modify start charging and stopping charging behaviour

#+BEGIN_EXAMPLE
gargle@p14:~/pandora/p14$ echo 60 | sudo tee  /sys/class/power_supply/BAT0/charge_start_threshold
60
gargle@p14:~/pandora/p14$ echo 80 | sudo tee cat /sys/class/power_supply/BAT0/charge_stop_threshold
80
#+END_EXAMPLE
